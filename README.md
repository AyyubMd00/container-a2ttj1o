...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a2ttj1o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a2ttj1o.containers.anotherwebservice.com/
...
```
git clone git@github.com:AyyubMd00/container-a2ttj1o.git
cd container-a2ttj1o
```
...
```
docker attach container-a2ttj1o
```
